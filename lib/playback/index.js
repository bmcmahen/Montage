...
Methods.add({
  ...
  forwardVideo: function(){
    currentVideo.forward();
  },
  backwardVideo: function(){
    currentVideo.backward();
  },
  pauseVideo: function(){
    if (currentVideo){
  ...
  volumeUp: function(){
    currentVideo.volumeUp();
  },
  volumeDown: function(){
    currentVideo.volumeDown();
  },
  toggleSubtitles: function(){
    currentVideo.toggleSubtitles();
  },
  nextSubtitleStream: function(){
    currentVideo.nextSubtitleStream();
  },
  previousSubtitleStream: function(){
    currentVideo.previousSubtitleStream();
  },
  nextChapter: function(){
    currentVideo.nextChapter();
  },
  previousChapter: function(){
    currentVideo.previousChapter();
  },
  quitVideo: function(){
    currentVideo.quit();
  }
